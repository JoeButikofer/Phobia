...
/// <summary>
/// Base class for loading scene from AssetBundles
/// From : https://github.com/JiYongYun/Unity-5.0-AssetBundle-Demo
/// </summary>
public class BaseLoader : MonoBehaviour {
	...
	public IEnumerator LoadLevel (string assetBundleName, string levelName, bool isAdditive)
	{
